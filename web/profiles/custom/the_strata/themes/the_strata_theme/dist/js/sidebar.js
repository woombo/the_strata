({
  "./js/sidebar.js": function() {
    ((Drupal, drupalSettings, once) => {
      const toolbarVariant = drupalSettings.gin.toolbar_variant, storageDesktop = "Drupal.gin.sidebarExpanded.desktop", resizer = document.getElementById("gin-sidebar-draggable"), resizable = document.getElementById("the_strata_theme_sidebar");
      ...
      Drupal.behaviors.ginSidebar = {
        ...
        init: function(context) {
          once("ginSidebarInit", "#the_strata_theme_sidebar", context).forEach((() => {
