(() => {
  if (localStorage.getItem("TheStrataThemeDarkMode") && localStorage.removeItem("TheStrataThemeDarkMode"), 
  localStorage.getItem("Drupal.gin.darkmode") && localStorage.removeItem("Drupal.gin.darkmode"), 
  localStorage.getItem("TheStrataThemeSidebarOpen") && (localStorage.setItem("Drupal.gin.toolbarExpanded", localStorage.getItem("TheStrataThemeSidebarOpen")), 
  localStorage.removeItem("TheStrataThemeSidebarOpen")), function() {
