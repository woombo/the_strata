...
function checkLegacy() {
  if (localStorage.getItem('TheStrataThemeDarkMode')) {
    localStorage.removeItem('TheStrataThemeDarkMode');
  }
  if (localStorage.getItem('Drupal.gin.darkmode')) {
    localStorage.removeItem('Drupal.gin.darkmode');
  }
  if (localStorage.getItem('TheStrataThemeSidebarOpen')) {
    localStorage.setItem('Drupal.gin.toolbarExpanded', localStorage.getItem('TheStrataThemeSidebarOpen'));
    localStorage.removeItem('TheStrataThemeSidebarOpen');
  }
}
