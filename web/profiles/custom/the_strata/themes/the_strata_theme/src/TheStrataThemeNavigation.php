 ...
 */
class TheStrataThemeNavigation implements ContainerInjectionInterface {
  ...
  public function getNavigationAdminMenuItems(): array {
    ...
    foreach ($tree as $item) {
      $pluthe_strata_theme_id = $item->link->getPluginId();
      $pluthe_strata_theme_class = str_replace('.', '_', $pluthe_strata_theme_id);
      $build['#items'][$pluthe_strata_theme_id]['class'] = $pluthe_strata_theme_class;
    }
